<?php 
   ...
   $products_query = mysqli_query($con, "SELECT * FROM products WHERE category = 'home'");
?>
<!DOCTYPE html>
<html lang ="en">
<head>
    ...
    <title>First E-commerce Website</title>
    ...
    <section id="header">
        ...
        <div>
            <ul id="navbar">
                ...
                <li><a class="active" href="home.php">Home & Living</a></li>
